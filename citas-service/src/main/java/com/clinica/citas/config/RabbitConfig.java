...
public class RabbitConfig {
    ...
    @Bean
    public Binding bindingCreated(@Qualifier("appointmentCreatedQueue") Queue appointmentCreatedQueue, TopicExchange appointmentExchange) {
        return BindingBuilder.bind(appointmentCreatedQueue).to(appointmentExchange).with("appointment.created");
    }

    @Bean
    public Binding bindingCancelled(@Qualifier("appointmentCancelledQueue") Queue appointmentCancelledQueue, TopicExchange appointmentExchange) {
